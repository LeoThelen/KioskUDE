...
<body>
	...
	<#list taglistlist as taglist>
		...
		<div class="grid">
			...
			<div class="grid-item ${game.classtags}" style="background-image: url(screenshots/sample.png); background-repeat: no-repeat ">
				${game.name} <br> <a href="/babble_details?gameid=${game.id}">Description comes here</a><br>
				<br>
			</div>
			</#if> </#list>
		</div>
